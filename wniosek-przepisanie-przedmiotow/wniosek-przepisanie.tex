    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|c|c|c|c|c|}
            ...
            \textbf{Przedmiot zaliczony}\textsuperscript{1} & \begin{tabular}{@{}c@{}}\textbf{Forma zajęć/liczba} \\ \textbf{godzin}\textsuperscript{2}\end{tabular} & 
                \begin{tabular}{@{}c@{}}\textbf{Punkty} \\ \textbf{ETCS}\end{tabular} & \textbf{Uzyskane oceny}\textsuperscript{3} & \begin{tabular}{@{}c@{}}\textbf{Rok} \\ \textbf{akademicki}\textsuperscript{4}\end{tabular}  \\ 
            \hline
              &   &   &   &   \\ 
            \hline
            \textbf{Przedmiot w IIiMK [nazwa]} & \begin{tabular}{@{}c@{}}\textbf{Forma zajęć/liczba} \\ \textbf{godzin}\end{tabular} & 
                \begin{tabular}{@{}c@{}}\textbf{Punkty} \\ \textbf{ETCS}\end{tabular} & \textbf{Ostateczne oceny}\textsuperscript{5} & \begin{tabular}{@{}c@{}}\textbf{Rok} \\ \textbf{akademicki}\textsuperscript{6}\end{tabular}  \\ 
            \hline
              &   &   &   &   \\ 
            \hline
...
\fnt{\label{note2}Forma zajęć czyli np. w-wykład, c-ćwiczenia, l-laboratorium, s-seminarium}
\fnt{\label{note3}Oceny uzyskane np. w-5.0 c-5.0}
\fnt{\label{note4}Rok akademicki, w którym przedmiot był faktycznie realizowany}
\fnt{\label{note3}Ostateczna ocena zatwierdzona do wpisania przez Kierownika studiów [pole należy zostawić puste]}
\fnt{\label{note4}Rok akademicki, w którym przedmiot ma być zaliczony}
